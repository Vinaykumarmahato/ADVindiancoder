                                        ...
                                        <div className="flex justify-between items-start mb-6">
                                            ...
                                            <div className="absolute top-24 right-8 z-30 group/share">
                                                <button 
                                                    ...
                                                    className="w-8 h-8 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 flex items-center justify-center hover:bg-primary transition-all duration-300 shadow-lg relative z-50"
                                                >
