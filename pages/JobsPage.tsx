        ...
        <PageWrapper>
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="text-center mb-12 relative">
                    ...
                    <motion.span initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="bg-primary/10 border border-primary/30 text-primary font-mono text-sm uppercase px-4 py-1.5 rounded-full mb-4 inline-block shadow-[0_0_15px_rgba(0,120,255,0.2)]">
                        Latest Opportunities
                    </motion.span>
                    <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-4xl md:text-6xl font-black mb-6">
                        Premium <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-primary">Job Openings</span>
                    </motion.h1>
                    <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-xl text-gray-400 max-w-2xl mx-auto mb-8">
                    ...
                    <motion.a 
                        ...
                        className="inline-flex items-center px-8 py-4 bg-[#0088cc] hover:bg-[#0077b3] text-white font-bold text-lg rounded-xl transition-all shadow-[0_0_20px_rgba(0,136,204,0.4)] hover:shadow-[0_0_30px_rgba(0,136,204,0.6)] hover:-translate-y-1"
                    >
