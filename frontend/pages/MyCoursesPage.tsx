...
const CoursesPage = () => {
    ...
    const categories = ['All', ...Array.from(new Set(COURSES.filter(course => isEnrolled(course.id.toString())).map(c => c.category)))];

    const filteredCourses = COURSES.filter(course => {
        if (!isEnrolled(course.id.toString())) return false;
    ...
    return (
        <PageWrapper>
            ...
            <div className="bg-white dark:bg-[#050914] text-gray-900 dark:text-white min-h-screen font-sans relative overflow-hidden transition-colors duration-300">
                ...
                {/* Header */}
                <div className="relative z-10 pt-36 sm:pt-40 md:pt-44 lg:pt-48 pb-20 text-center px-4">
                    ...
                    <div className="max-w-4xl mx-auto relative">
                        ...
                        >
                            My <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500">Courses.</span>
                        </motion.h1>
                        <motion.p 
                        ...
                        >
                            Continue learning from where you left off. Access your enrolled masterclasses and zero-to-hero courses.
                        </motion.p>
                    </div>
                </div>
