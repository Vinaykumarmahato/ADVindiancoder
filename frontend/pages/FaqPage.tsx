...
const FaqItem = ({ question, answer }: { question: string, answer: React.ReactNode }) => {
    ...
    return (
        <div className="border border-gray-200 dark:border-white/10 rounded-2xl mb-4 bg-white dark:bg-white/5 backdrop-blur-md overflow-hidden relative group transition-colors hover:border-primary/30 shadow-sm dark:shadow-md text-gray-900 dark:text-white">
            ...
            >
                <span className={`font-bold text-lg pr-4 transition-colors ${isOpen ? 'text-primary' : 'text-gray-900 dark:text-white'}`}>{question}</span>
            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        <div className="p-6 pt-0 text-gray-655 dark:text-gray-400 font-light leading-relaxed border-t border-gray-100 dark:border-white/5 mt-2">
                            {answer}
                        </div>
                    </motion.div>
                )}
            ...
            <div className="bg-white dark:bg-[#050914] text-gray-900 dark:text-white min-h-screen font-sans relative overflow-hidden flex flex-col transition-colors duration-300">
                ...
                <div className="relative z-10 pt-36 sm:pt-40 md:pt-44 lg:pt-48 pb-24 text-center px-4">
                    ...
                    <div className="max-w-4xl mx-auto relative">
                        <motion.span initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} className="bg-indigo-500/10 backdrop-blur-md border border-indigo-500/30 text-indigo-605 dark:text-indigo-400 font-mono text-sm tracking-widest py-2 px-6 rounded-full mb-6 inline-flex shadow-sm dark:shadow-[0_0_20px_rgba(99,102,241,0.2)]">
                            CLARITY HUB
                        </motion.span>
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-32 flex-grow">
                    <motion.div variants={fadeUp} initial="hidden" animate="show" className="space-y-16">
                        ...
                        {/* General Questions */}
                        <section>
                            <h2 className="text-3xl font-black mb-8 text-gray-900 dark:text-white flex items-center gap-4"><span className="bg-gray-100 dark:bg-white/10 border border-gray-200 dark:border-white/20 p-3 rounded-2xl">📌</span> Core Directives</h2>
                        ...
                        {/* Course Questions */}
                        <section>
                            <h2 className="text-3xl font-black mb-8 text-gray-900 dark:text-white flex items-center gap-4"><span className="bg-gray-100 dark:bg-white/10 border border-gray-200 dark:border-white/20 p-3 rounded-2xl">💻</span> Protocol specific details</h2>
                        ...
                        {/* Career Questions */}
                        <section>
                            <h2 className="text-3xl font-black mb-8 text-gray-900 dark:text-white flex items-center gap-4"><span className="bg-gray-100 dark:bg-white/10 border border-gray-200 dark:border-white/20 p-3 rounded-2xl">🚀</span> Placement Infrastructure</h2>
                            ...
                            <FaqItem question="What job titles do these skills unlock?" answer={
                                <ul className="list-disc pl-5 mt-4 space-y-2 text-gray-600 dark:text-gray-400">
                                    <li><strong className="text-gray-950 dark:text-white">Python Cohort:</strong> Junior Backend Dev, Data Analyst, QA Automation Eng.</li>
                                    <li><strong className="text-gray-950 dark:text-white">Java Masterclass:</strong> Core Java Developer, Enterprise Engineer, Spring Boot Dev.</li>
                                    <li><strong className="text-gray-950 dark:text-white">SQL Architecture:</strong> DBA, Business Intelligence Analyst, Data Manager.</li>
                                    <li><strong className="text-gray-950 dark:text-white">Prompt Eng:</strong> AI Logic specialist, Automation Consultant.</li>
                                </ul>
                            } />
                        </section>
                        ...
                        {/* Payment Questions */}
                        <section>
                            <h2 className="text-3xl font-black mb-8 text-gray-900 dark:text-white flex items-center gap-4"><span className="bg-gray-100 dark:bg-white/10 border border-gray-200 dark:border-white/20 p-3 rounded-2xl">💳</span> Enrollment & Transactions</h2>
                    ...
                    <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="mt-32 relative text-center">
                        ...
                        <div className="relative z-10 bg-white dark:bg-[#0a0f1c] rounded-[3rem] p-12 lg:p-16 border border-gray-200 dark:border-white/10 shadow-md dark:shadow-2xl text-gray-900 dark:text-white">
                            <MessageSquare className="w-16 h-16 text-[#25D366] mx-auto mb-6" />
                            <h3 className="text-4xl font-black text-gray-950 dark:text-white mb-4">Still analyzing?</h3>
                            <p className="text-lg text-gray-655 dark:text-gray-400 mb-10 max-w-xl mx-auto font-light">Stop guessing. Ping our mentors directly on WhatsApp and get your specific queries resolved in minutes.</p>
