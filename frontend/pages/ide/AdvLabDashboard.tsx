            ...
            <div className="min-h-screen bg-white dark:bg-[#05060f] text-gray-900 dark:text-white font-sans selection:bg-primary/30 overflow-x-hidden transition-colors duration-300">
                ...
                <section className="relative z-10 flex flex-col items-center justify-center px-4 pt-6 md:pt-10 pb-16">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-650 dark:text-gray-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
                ...
                <section className="relative z-10 px-4 pb-24 max-w-6xl mx-auto">
                    <div className="text-center mb-14">
                        ...
                        <p className="text-gray-600 dark:text-gray-500 max-w-2xl mx-auto text-base md:text-lg">
                            Every other online IDE lets you run code. ADV Lab lets you <strong className="text-gray-950 dark:text-white">build your professional profile</strong> while you code.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {FEATURES.map((feature, i) => {
                            ...
                            return (
                                <div
                                    key={i}
                                    className="group relative bg-white dark:bg-[#0a0f1c] border border-gray-200 dark:border-white/8 rounded-[2rem] p-7 flex flex-col gap-5 hover:border-primary/20 dark:hover:border-white/20 transition-all duration-500 hover:shadow-lg dark:hover:shadow-[0_0_50px_rgba(0,0,0,0.4)] hover:-translate-y-1 overflow-hidden"
                                >
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className={`text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full border border-gray-200 dark:border-white/10 ${feature.badgeColor}`}>
                                            {feature.badge}
                                        </span>
                                    </div>
                                    ...
                                    {/* Description */}
                                    <p className="text-gray-650 dark:text-gray-500 text-sm leading-relaxed flex-1">
                                        {feature.description}
                                    </p>

                                    {/* Highlight pill */}
                                    <div className="bg-gray-100 dark:bg-black/40 border border-gray-205 dark:border-white/5 rounded-xl px-4 py-2.5">
                    ...
                    {/* Bottom CTA banner */}
                    <div className="mt-16 relative bg-gradient-to-r from-red-600/20 via-purple-600/20 to-blue-600/20 border border-gray-250 dark:border-white/10 rounded-[2rem] p-8 md:p-12 text-center overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-br from-red-500/5 to-blue-500/5"></div>
                        <div className="relative z-10">
                            <div className="flex items-center justify-center gap-3 mb-5">
                                <Users className="w-6 h-6 text-red-400" />
                                <span className="text-sm font-black uppercase tracking-widest text-gray-650 dark:text-gray-400">Join Students Already Using ADV Lab</span>
                            </div>
                            <h3 className="text-2xl md:text-4xl font-black text-gray-950 dark:text-white mb-4">
                            ...
                            <p className="text-gray-650 dark:text-gray-400 mb-8 max-w-xl mx-auto">
