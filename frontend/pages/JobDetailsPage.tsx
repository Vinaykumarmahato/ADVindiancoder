    ...
    return (
        <PageWrapper>
            <SEO 
                ...
                schema={jobSchema}
            />
            <div className="bg-white dark:bg-[#050914] min-h-screen text-gray-900 dark:text-white font-sans relative pb-24 transition-colors duration-300">
                {/* Background Grid */}
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 relative z-10">
                    <Link to={backLink} className="inline-flex items-center text-gray-600 dark:text-gray-400 hover:text-gray-950 dark:hover:text-white mb-8 transition-colors bg-gray-100 dark:bg-white/5 px-4 py-2 rounded-full border border-gray-200 dark:border-white/10 backdrop-blur-sm shadow-sm">
                        <ArrowLeft className="w-4 h-4 mr-2" />
                        {backText}
                    </Link>
                    
                    {/* Hero Section / Quick Overview */}
                    <div className="bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-[2rem] p-8 md:p-12 shadow-sm dark:shadow-2xl backdrop-blur-md mb-12 relative overflow-hidden">
                        ...
                        <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-8 relative z-10">
                            <div className="flex-1">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <span className="text-gray-600 dark:text-gray-400 text-sm flex items-center"><Clock className="w-4 h-4 mr-1" /> {job.postedDate}</span>
                                </div>
                                <h1 className="text-3xl sm:text-4xl md:text-5xl font-black mb-6 leading-tight text-gray-950 dark:text-white">{job.title}</h1>
                                
                                {/* Quick Overview Badges */}
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm font-medium text-gray-900 dark:text-white">
                                    <div className="flex items-center bg-gray-50 dark:bg-black/40 border border-gray-200 dark:border-white/10 px-4 py-3 rounded-xl">
                                        <Building2 className="w-5 h-5 mr-3 text-blue-450 shrink-0" />
                                        <div className="min-w-0">
                                            <p className="text-[10px] text-gray-600 dark:text-gray-400 uppercase tracking-wider">Company</p>
                                            <p className="text-gray-950 dark:text-white truncate">{job.company}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center bg-gray-50 dark:bg-black/40 border border-gray-200 dark:border-white/10 px-4 py-3 rounded-xl">
                                        <MapPin className="w-5 h-5 mr-3 text-red-450 shrink-0" />
                                        <div className="min-w-0">
                                            <p className="text-[10px] text-gray-600 dark:text-gray-400 uppercase tracking-wider">Location</p>
                                            <p className="text-gray-950 dark:text-white truncate">{job.location}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center bg-gray-50 dark:bg-black/40 border border-gray-200 dark:border-white/10 px-4 py-3 rounded-xl">
                                        <Briefcase className="w-5 h-5 mr-3 text-green-450 shrink-0" />
                                        <div className="min-w-0">
                                            <p className="text-[10px] text-gray-600 dark:text-gray-400 uppercase tracking-wider">Experience</p>
                                            <p className="text-gray-955 dark:text-white truncate">{job.experience}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center bg-gray-50 dark:bg-black/40 border border-gray-200 dark:border-white/10 px-4 py-3 rounded-xl">
                                        <DollarSign className="w-5 h-5 mr-3 text-yellow-450 shrink-0" />
                                        <div className="min-w-0">
                                            <p className="text-[10px] text-gray-600 dark:text-gray-400 uppercase tracking-wider">Salary</p>
                                            <p className="text-gray-955 dark:text-white truncate">{job.salary}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-4 shrink-0 w-full md:w-auto">
                                ...
                                <div className="flex justify-center gap-3">
                                    <p className="text-sm text-gray-600 dark:text-gray-400 flex items-center mr-2"><Share2 className="w-4 h-4 mr-2"/> Share:</p>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="md:col-span-2 space-y-10">
                            <section>
                                <h2 className="text-2xl font-bold mb-4 flex items-center border-b border-gray-200 dark:border-white/10 pb-4 text-gray-950 dark:text-white">
                                    <Building2 className="w-6 h-6 mr-3 text-primary" /> About {job.company}
                                </h2>
                                <p className="text-gray-650 dark:text-gray-300 leading-relaxed text-lg">{job.aboutCompany}</p>
                            </section>
                            ...
                            <section>
                                ...
                                <p className="text-gray-650 dark:text-gray-300 leading-relaxed text-lg">{job.description}</p>
                            </section>
                            ...
                            <section>
                                ...
                                <ul className="space-y-4">
                                    {job.responsibilities.map((req, idx) => (
                                        <li key={idx} className="flex items-start text-gray-650 dark:text-gray-300 text-lg">
                           ...
                           <section>
                            ...
                            <section>
                                <h2 className="text-2xl font-bold mb-6 flex items-center border-b border-gray-200 dark:border-white/10 pb-4 text-gray-950 dark:text-white">
                                    <HelpCircle className="w-6 h-6 mr-3 text-primary" /> Frequently Asked Questions
                                </h2>
                                <div className="space-y-4 text-gray-900 dark:text-white">
                                    {job.faqs.map((faq, idx) => (
                                        <div key={idx} className="bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl overflow-hidden shadow-sm">
                                            <button 
                                                className="w-full px-6 py-4 flex justify-between items-center text-left hover:bg-gray-100 dark:hover:bg-white/5 transition-colors focus:outline-none"
                                                onClick={() => setOpenFaq(openFaq === idx ? null : idx)}
                                            >
                                                <span className="font-semibold text-lg">{faq.q}</span>
                                                {openFaq === idx ? <ChevronUp className="w-5 h-5 text-gray-500 dark:text-gray-400" /> : <ChevronDown className="w-5 h-5 text-gray-500 dark:text-gray-400" />}
                                            </button>
                                            <AnimatePresence>
                                                {openFaq === idx && (
                                                    <motion.div 
                        ...
                        <div className="space-y-8 text-gray-900 dark:text-white">
                            <div className="bg-white dark:bg-gradient-to-b dark:from-white/10 dark:to-transparent border border-gray-200 dark:border-white/10 rounded-[2rem] p-8 shadow-sm dark:shadow-xl backdrop-blur-sm">
                                <h3 className="text-xl font-bold mb-6 flex items-center text-gray-950 dark:text-white"><CheckCircle2 className="w-5 h-5 mr-3 text-green-400" /> Required Skills</h3>
                                <div className="flex flex-wrap gap-3">
                                    {job.skills.map((skill, idx) => (
                                        <span key={idx} className="bg-gray-50 dark:bg-black/50 border border-gray-200 dark:border-white/10 text-gray-700 dark:text-gray-300 px-4 py-2 rounded-lg text-sm font-medium shadow-sm">
                                            {skill}
                                        </span>
                                    ))}
                                </div>
                            ...
                            <div className="bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-[2rem] p-8 shadow-sm dark:shadow-xl backdrop-blur-sm">
                                <h3 className="text-xl font-bold mb-6 flex items-center text-gray-950 dark:text-white"><Gift className="w-5 h-5 mr-3 text-yellow-400" /> Salary & Benefits</h3>
                                <ul className="space-y-4">
                                    {job.benefits.map((benefit, idx) => (
                                        <li key={idx} className="flex items-start text-gray-650 dark:text-gray-300 text-sm">
                            ...
                            <div className="bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-[2.5rem] p-8 shadow-sm dark:shadow-2xl backdrop-blur-xl relative overflow-hidden group/process text-gray-900 dark:text-white">
                                ...
                                <h3 className="text-2xl font-black mb-8 flex items-center tracking-tight text-gray-950 dark:text-white">
                                    ...
                                    {job.applicationProcess.map((step, idx) => (
                                        ...
                                        >
                                            ...
                                            <div className="relative z-10 shrink-0">
                                                <div className="w-10 h-10 rounded-full bg-white dark:bg-[#050914] border-2 border-primary flex items-center justify-center text-primary font-black text-sm shadow-[0_0_15px_rgba(0,120,255,0.3)] group-hover/item:scale-110 group-hover/item:shadow-[0_0_25px_rgba(0,120,255,0.5)] transition-all duration-300">
                                                    {idx + 1}
                                                </div>
                                            ...
                                            <div className="flex-1 pt-0.5">
                                                <div className="p-5 rounded-2xl bg-gray-50 dark:bg-white/[0.03] border border-gray-200 dark:border-white/5 group-hover/item:bg-gray-100 dark:group-hover/item:bg-white/[0.07] group-hover/item:border-primary/30 transition-all duration-300 shadow-md dark:shadow-lg backdrop-blur-sm">
                                                    <div className="flex flex-col gap-1">
                                                        <span className="text-[10px] font-black uppercase tracking-[0.2em] text-primary/70 mb-1">Step 0{idx + 1}</span>
                                                        <p className="text-gray-700 dark:text-gray-200 font-medium leading-relaxed group-hover/item:text-gray-950 group-hover/item:dark:text-white transition-colors">
                                                            {step}
                                                        </p>
                                                    </div>
                                                </div>
                    ...
                    {/* Final Bottom CTA */}
                    <div className="mt-20 pt-12 pb-12 border-t border-gray-200 dark:border-white/10 text-center relative text-gray-900 dark:text-white">
                        ...
                        <h2 className="text-4xl font-black mb-6 text-gray-950 dark:text-white">Ready to join our team?</h2>
                        <p className="text-xl text-gray-600 dark:text-gray-400 mb-10 max-w-2xl mx-auto">Take the next step in your career journey. Apply online and secure your future.</p>
                        <a 
                            href={applyTarget}
                            target={job.applyLink ? "_blank" : "_self"}
                            rel="noopener noreferrer"
