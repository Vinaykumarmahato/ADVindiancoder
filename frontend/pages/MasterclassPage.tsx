    ...
    return (
        <PageWrapper>
            ...
            <div className="bg-white dark:bg-[#050914] text-gray-900 dark:text-white min-h-screen font-sans relative overflow-hidden transition-colors duration-300">
                ...
                {/* Header */}
                <div className="relative z-10 pt-36 sm:pt-40 md:pt-44 lg:pt-48 pb-16 text-center px-4">
                    <GlowingOrb className="top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-primary/20" />
                    <div className="max-w-5xl mx-auto relative">
                        <motion.span initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} className="bg-gray-100 dark:bg-white/10 backdrop-blur-md border border-primary/30 text-primary font-mono text-sm tracking-widest py-2 px-6 rounded-full mb-6 inline-flex shadow-sm dark:shadow-[0_0_20px_rgba(0,120,255,0.3)]">
                        ...
                        <motion.p initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4, duration: 1 }} className="text-xl md:text-2xl text-gray-650 dark:text-gray-400 max-w-3xl mx-auto font-light leading-relaxed">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-20">
                        <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="bg-white dark:bg-white/5 backdrop-blur-xl border border-gray-200 dark:border-white/10 p-10 rounded-[2rem] relative overflow-hidden group hover:border-primary/20 dark:hover:border-white/20 transition-all text-gray-900 dark:text-white">
                            ...
                            <h2 className="text-3xl font-extrabold mb-8 text-gray-900 dark:text-white relative z-10">The Live Advantage</h2>
                            <ul className="space-y-6 relative z-10">
                                {[
                                    ...
                                    <li key={i} className="flex items-start">
                                        ...
                                        <span className="text-lg text-gray-650 dark:text-gray-300">{text}</span>
                                    </li>
                                ))}
                            </ul>
                        </motion.div>
                        
                        <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="bg-gradient-to-br from-primary/5 via-blue-50/20 to-blue-900/10 dark:from-primary/10 dark:to-blue-900/40 backdrop-blur-xl border border-primary/20 dark:border-primary/30 p-10 rounded-[2rem] relative overflow-hidden text-gray-900 dark:text-white">
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center border-b border-gray-200 dark:border-white/10 pb-4 gap-1">
                                        <span className="text-gray-600 dark:text-gray-400 font-mono text-xs sm:text-sm uppercase tracking-wider">Timing</span>
                                        <span className="font-bold text-lg sm:text-xl">7:00 PM - 9:00 PM IST</span>
                                    </div>
                                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center border-b border-gray-200 dark:border-white/10 pb-4 gap-1">
                                        <span className="text-gray-600 dark:text-gray-400 font-mono text-xs sm:text-sm uppercase tracking-wider">Platform</span>
                                        <span className="font-bold text-lg sm:text-xl">Zoom Premium</span>
                                    </div>
                                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center border-b border-gray-200 dark:border-white/10 pb-4 gap-1">
                                        <span className="text-gray-600 dark:text-gray-400 font-mono text-xs sm:text-sm uppercase tracking-wider">Availability</span>
                                        <span className="font-bold text-lg sm:text-xl text-red-400">Strictly Limited Seats</span>
                                    </div>
                                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center border-b border-gray-200 dark:border-white/10 pb-4 gap-1">
                                        <span className="text-gray-600 dark:text-gray-400 font-mono text-xs sm:text-sm uppercase tracking-wider">Language</span>
                    ...
                    <div className="text-center mb-16 relative py-10">
                        <motion.h2 
                            ...
                            className="text-4xl md:text-6xl font-black mb-4 text-gray-900 dark:text-white"
                        >
                            Live 30-Day Mentorship Program
                        </motion.h2>
                        <p className="text-xl md:text-2xl text-gray-650 dark:text-gray-400 font-light mb-12">
                    ...
                    <div id="cohorts" className="text-center mb-16 relative">
                        <h2 className="text-4xl font-black mb-4 text-gray-900 dark:text-white">Select Your Cohort</h2>
                        <p className="text-xl text-gray-650 dark:text-gray-400 italic">Special Limited Price Applies to all batches today.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
                        {MASTERCLASSES.map((mc, idx) => (
                            <motion.div
                                ...
                                className="group relative bg-white dark:bg-[#0a0f1c] border border-gray-200 dark:border-white/10 rounded-[2rem] p-8 hover:border-primary/50 transition-all duration-500 flex flex-col justify-between overflow-hidden shadow-xl text-gray-900 dark:text-white"
                            >
                                ...
                                <div className="relative z-10">
                                    <div className="flex flex-col mb-6 space-y-2">
                                        <div className="flex justify-between items-start gap-4">
                                            ...
                                            <span className="shrink-0 px-4 py-1.5 bg-gray-150 dark:bg-white/10 backdrop-blur-md rounded-full text-sm font-mono font-bold text-primary group-hover:bg-primary/20 transition-colors border border-primary/20 group-hover:border-primary/50">
                                                ₹{mc.price}
                                            </span>
                                        </div>
                                        {mc.title.includes('(') && (
                                    ...
                                    <p className="text-gray-655 dark:text-gray-400 mb-8 font-light leading-relaxed">{mc.description}</p>
                                    
                                    <div className="mb-8 p-5 bg-gray-50 dark:bg-white/5 rounded-2xl border border-gray-200 dark:border-white/5 group-hover:border-primary/20 dark:group-hover:border-white/10 transition-colors">
                                        <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-300">
                                            ...
                                            <li className="flex items-center"><Github className="w-4 h-4 mr-3 text-gray-900 dark:text-white" /> Free GitHub Mastery</li>
                                ...
                                <div className="relative z-10 mt-auto">
                                    <div className="mb-6">
                                        <p className="text-xs tracking-widest text-gray-600 dark:text-gray-500 uppercase font-bold text-center mb-3">Enrolling Closes In</p>
                                        <CountdownTimer targetDate={mc.countdownTarget} />
                                    </div>
                                    <button
                                        onClick={() => handleEnrollClick(mc)}
                                        className="w-full bg-gray-950 dark:bg-white text-white dark:text-black font-black text-lg py-4 rounded-xl hover:bg-gray-900 dark:hover:bg-gray-200 transition-colors shadow-md dark:shadow-[0_0_20px_rgba(255,255,255,0.1)] group-hover:shadow-[0_0_30px_rgba(255,255,255,0.3)]"
                                    >
                                        Enroll Now
                                    </button>
                                </div>
                    ...
                    {selectedMc && (
                        ...
                        >
                            <motion.div
                                ...
                                className="bg-white dark:bg-[#0f1524] border border-gray-200 dark:border-white/20 rounded-3xl p-8 max-w-lg w-full max-h-[90vh] overflow-y-auto shadow-2xl relative text-gray-950 dark:text-white"
                                onClick={e => e.stopPropagation()}
                             >
                                <div className="flex justify-between items-center mb-8 pb-4 border-b border-gray-200 dark:border-white/10">
                                    <h2 className="text-2xl font-black text-gray-950 dark:text-white">Enroll in {selectedMc.title}</h2>
                                    <button onClick={() => setSelectedMc(null)} className="p-2 hover:bg-gray-100 dark:hover:bg-white/10 rounded-full transition-colors text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                                    ...
                                    <div className="space-y-8">
                                        ...
                                        <form onSubmit={handleSubmit} className="space-y-5">
                                            ...
                                            <div className="space-y-4">
                                                <input type="text" placeholder="Legal Full Name" required className="w-full p-4 rounded-xl bg-gray-50 dark:bg-black/50 border border-gray-250 dark:border-white/10 text-gray-800 dark:text-white placeholder-gray-500 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors" value={formData.name} onChange={e => setFormData({ ...formData, name: e.target.value })}/>
                                                <input type="email" placeholder="Professional Email" required className="w-full p-4 rounded-xl bg-gray-50 dark:bg-black/50 border border-gray-255 dark:border-white/10 text-gray-800 dark:text-white placeholder-gray-500 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors" value={formData.email} onChange={e => setFormData({ ...formData, email: e.target.value })}/>
                                                <input type="tel" placeholder="WhatsApp Number" required className="w-full p-4 rounded-xl bg-gray-50 dark:bg-black/50 border border-gray-255 dark:border-white/10 text-gray-800 dark:text-white placeholder-gray-500 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors" value={formData.phone} onChange={e => setFormData({ ...formData, phone: e.target.value })}/>
                                                
                                                <div className="bg-gray-50 dark:bg-black/50 border border-gray-200 dark:border-white/10 rounded-xl p-4 overflow-hidden">
                                                    <p className="text-xs text-gray-650 dark:text-gray-500 uppercase tracking-widest font-bold mb-3">Preferred Language</p>
                                                    <div className="flex gap-4">
                                                        {['English', 'Hindi'].map((lang) => (
                                                            <label key={lang} className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-lg border cursor-pointer transition-all ${formData.language === lang ? 'bg-primary/10 dark:bg-primary/20 border-primary text-primary' : 'bg-gray-100 dark:bg-white/5 border-gray-250 dark:border-white/10 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-white/10'}`}>
                                                ...
                                                <input type="text" placeholder="12-Digit UTR / Transaction ID" required className="w-full p-4 rounded-xl bg-gray-50 dark:bg-black/50 border border-gray-255 dark:border-white/10 text-gray-800 dark:text-white placeholder-gray-500 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors" value={formData.transactionId} onChange={e => setFormData({ ...formData, transactionId: e.target.value })}/>
                                            </div>

                                            <div className="border-2 border-dashed border-gray-250 dark:border-white/20 hover:border-primary/50 relative bg-gray-50 dark:bg-black/30 rounded-xl p-6 text-center cursor-pointer transition-colors group">
                                                ...
                                                <p className="text-sm font-semibold text-gray-655 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-gray-300">
                                                    {file ? <span className="text-green-500 dark:text-green-400 flex items-center justify-center gap-2"><CheckCircle className="w-4 h-4"/> {file.name}</span> : "Click or drag Payment Screenshot here"}
                                                </p>
                                            </div>

                                            <button type="submit" disabled={loading} className="w-full bg-gray-950 dark:bg-white text-white dark:text-black font-black text-lg py-4 rounded-xl hover:bg-gray-900 dark:hover:bg-gray-200 transition-all shadow-[0_0_20px_rgba(255,255,255,0.2)] disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none hover:scale-[1.02]">
