...
export const COURSES: Course[] = [
    {
        ...
        description: "Master Java from scratch with zero prior knowledge. This 44-episode series covers everything from basics to advanced OOPs, patterns, and DSA foundations with AI-driven learning approach.",
