...
out = []
out.append("""import React, { useState } from 'react';
...
for t in topics:
    out.append(f"""        {{
            id: {repr(t['id'])},
            title: {repr(t['title'])},
            definition: {repr(t['definition'])},
            syntax: {repr(t['syntax'])},
            codeSnippet: {repr(t['codeSnippet'])},
            realLifeScenario: {repr(t['realLifeScenario'])},
            content: (
                <div className="space-y-6">
                    ...
                    <div className="bg-white dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
                        ...
                        <MermaidDiagram chart={`{t['mermaid']}`} />
                    </div>
                    ...
                    <div className="bg-white dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
                        ...
                        <CodeBlock code={{`{repr(t['codeSnippet'])[1:-1].replace("`", "")}`}} lang="python" />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-slate-900 text-slate-100 p-4 rounded-xl">
                            ...
                            <ul className="list-disc list-inside text-sm space-y-1 text-slate-300">
                                ...
                                <li>Scales effectively with <code className="text-cyan-400">computational power</code></li>
                        ...
                        <div className="bg-slate-900 text-slate-100 p-4 rounded-xl">
                            ...
                            <ul className="list-disc list-inside text-sm space-y-1 text-slate-300">
                                <li>Requires high quality <code className="text-cyan-400">data</code></li>
...
with open('c:\\\\Users\\\\vinay\\\\Videos\\\\Development Journey\\\\full stack app for adv indian coder\\\\ADVindiancoder\\\\frontend\\\\pages\\\\courses\\\\AiCoursePage.tsx', 'w', encoding='utf-8') as f:
    f.write('\\n'.join(out))
